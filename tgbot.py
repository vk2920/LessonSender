...
def get_help(message):
    return "Итак, в этом боте ты можешь узнать расписание на сегодня, " \
           ...
           "    неделя — получить инфу о парах на текущей неделе (в проекте)\n" \
           "    все_пары — получить инфу о всём расписании на 2 недели (в проекте)\n" \
...
async def echo(message: types.Message):
    ...
    if message.from_user.id in ban_list: # Отсеяли забаненых
        ...
        elif cmd[0] in ["помощь", "help", "хелп", "хэлп", "рудз"]:
